        ...
        fetch('http://localhost:3000/dashboard/savinggoals', {
            ...
            .then((data) => {
                ...
                data.forEach((element) => {
                    const existingGoal = goalsFromDB.find((goal) => goal.category === element.category);
                    if (existingGoal) {
    ...
    return (
        <div className='Goals'>
            ...
            <div className='donut-div'>
                <ApexDonut goals={goals} dropDown={dropDown} setReachGoal={setReachGoal} />
                {
                    goals.map((goal) => {
                            ...
                            return (
                                <>
                                    <div className='donut-label'>
                                        ...
                                        {!reachedGoal &&
                                            <p id='donut-p'>${goal.goal - goal.total} to {goal.category}</p>
                                        }
                                    </div>
                                </>
                            )
