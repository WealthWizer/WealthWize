    ...
    return (
        <div className='Sidebar'>
            <div className='closed-button'>
                <button onClick={() => setSidebar(false)} id='close-button'><CloseIcon /></button>
            </div>
            <div className=''></div>
            <div className='sidebar-content'>
                <div className="sidebar-selection">
                    <button className="expense" value="expense" onClick={(e) => handleSideBarSelection(e.target.value)}>Expense</button>
                    <button className="budget" value="budget" onClick={(e) => handleSideBarSelection(e.target.value)}>Budget</button>
                    <button className="goal" value="goal" onClick={(e) => handleSideBarSelection(e.target.value)}>Goal</button>
                </div>
                {expenseSelection && 
                <ExpenseForm />
                }
